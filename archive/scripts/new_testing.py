...
def detect_order_blocks(df: pd.DataFrame,
                        ...
                        atr_period_mult: Optional[float] = None) -> Tuple[List[OrderBlock], List[Signal], List[Position], pd.DataFrame]:
    """
...
break_atr_mult = 0.1         # require breakout > 0.2 * ATR
...
atr_period_mult = 0.7        # ATR window multiplier of swing_length (atr_period = round(swing_length * atr_period_mult))
...
take_profit_multiplier = 4       # TP distance = SL_distance × this multiplier
...
trailing_stop_percent = 1.5        # trail stop by this % below highest (longs) or above lowest (shorts)
